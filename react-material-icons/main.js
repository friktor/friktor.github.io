...
var CodeMirror = React.createClass({
  ...
  componentWillUnmount () { if (this.codeMirror) { this.codeMirror.toTextArea(); } },
  focusChanged (focused) { this.setState({ isFocused: focused }); },
  focus () { if (this.codeMirror) this.codeMirror.focus(); },
  getInitialState () { return { isFocused: false }; },
  getCodeMirror () { return this.codeMirror; },
...
var MorphIcon = require("react-morph-material-icons");
        ...
        <div style={{display: "flex", justifyContent: "center", paddingBottom:20}}>
          <CodeMirror options={optionsEditor} value={docs} />
        </div>
