...
var SampleIcon = React.createClass({displayName: "SampleIcon",
  getInitialState:function() {
    return {
      shapes: {
  ...
  render:function () {
    return (
      React.createElement("div", {style: {background: 'rgba(255,255,255,0.6)', padding: '10px 20px', borderRadius: 3, display: 'inline-block', width: 'auto', margin: '10px 0'}},
  ...
  render:function() {
    ...
    var icons = IconsKey.map(function(icon)  {
      return (
        React.createElement("div", {style: styles.block},
          ...
          React.createElement("span", {style: styles.span}, icon)
        )
      );
    });
    ...
    return (
      React.createElement("div", null,
        React.createElement("div", {className: "header", style: styles.header.root},
          React.createElement("h4", {style: styles.header.h4}, "React Material Icons"),
          React.createElement("p", {style: styles.header.p}, "Based on SVG-Morpheus Transform"),
          React.createElement(SampleIcon, null), " ", React.createElement("br", null),
          React.createElement(CodeMirror, {value: sampleCode, options: optionsEditor})
        ),
        React.createElement("h4", {style: styles.h4}, "How to use this?"),
        React.createElement("div", {style: {paddingBottom: 20, textAlign: 'center'}},
          React.createElement(CodeMirror, {style: {width: '100%'}, options: optionsEditor, value: docs})
        ),
        React.createElement("h4", {style: styles.h4}, "List All Icons"),
        React.createElement("div", {style: styles.container}, " ", icons, " ")
      )
    );
  }
});
